...
public class NMSMerchantRecipe185 {
	private MerchantRecipe merchantRecipe;

	public NMSMerchantRecipe185(MerchantRecipe merchantRecipe) {
		this.merchantRecipe = merchantRecipe;
	}

	public NMSMerchantRecipe185(ItemStack item1, ItemStack item3) {
		this(item1, null, item3);
	}

	public NMSMerchantRecipe185(ItemStack item1, ItemStack item2, ItemStack item3) {
		this.merchantRecipe = new MerchantRecipe185(item1, item2, item3, 0, 99999999);
	}
