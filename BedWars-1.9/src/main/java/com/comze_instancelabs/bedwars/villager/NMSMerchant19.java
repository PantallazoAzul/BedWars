...
public class NMSMerchant19 {
	private NMSMerchantRecipeList19 o = new NMSMerchantRecipeList19();
	...
	public void addOffer(MerchantRecipe recipe) {
		this.o.add(new NMSMerchantRecipe19(recipe));
	}
	...
	public void setRecipes(NMSMerchantRecipeList19 recipes) {
		this.o = recipes;
	}
