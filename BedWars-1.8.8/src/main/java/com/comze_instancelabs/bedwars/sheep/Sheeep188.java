...
public class Sheeep188 extends EntitySheep implements Sheeep {

	public Sheeep188(World world, Entity target) {
		super(world);
		...
		this.goalSelector.a(0, new PathfinderGoalMeleeAttack188(this, EntityHuman.class, 1D, false));
