...
public class Sheeep178 extends EntitySheep implements Sheeep {

	public Sheeep178(World world, Entity target) {
		super(world);
		try {
		...
		this.goalSelector.a(0, new PathfinderGoalMeleeAttack178(this, EntityHuman.class, 1D, false));
