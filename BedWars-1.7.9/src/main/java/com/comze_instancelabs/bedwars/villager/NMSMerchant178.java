...
public class NMSMerchant178 {
	private NMSMerchantRecipeList178 o = new NMSMerchantRecipeList178();
	...
	public void addOffer(MerchantRecipe recipe) {
		this.o.add(new NMSMerchantRecipe178(recipe));
	}
	...
	public void setRecipes(NMSMerchantRecipeList178 recipes) {
		this.o = recipes;
	}
