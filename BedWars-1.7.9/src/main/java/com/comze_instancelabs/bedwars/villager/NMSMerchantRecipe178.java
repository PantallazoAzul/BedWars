...
public class NMSMerchantRecipe178 {
	private MerchantRecipe merchantRecipe;

	public NMSMerchantRecipe178(MerchantRecipe merchantRecipe) {
		this.merchantRecipe = merchantRecipe;
	}

	public NMSMerchantRecipe178(ItemStack item1, ItemStack item3) {
		this(item1, null, item3);
	}

	public NMSMerchantRecipe178(ItemStack item1, ItemStack item2, ItemStack item3) {
