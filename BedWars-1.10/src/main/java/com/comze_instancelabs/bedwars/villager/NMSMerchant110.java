...
public class NMSMerchant110 {
	private NMSMerchantRecipeList110 o = new NMSMerchantRecipeList110();
	...
	public void addOffer(MerchantRecipe recipe) {
		this.o.add(new NMSMerchantRecipe110(recipe));
	}
	...
	public void setRecipes(NMSMerchantRecipeList110 recipes) {
		this.o = recipes;
	}
